...
<div class="htnr">
	<div class="container">
    	...
    	<div class="col-md-9">
          ...
          <div class="tscl-1">
            退款状态：<font color="#f00">退款成功（退款金额<?=$refund['arbitrate_result_amount']?>元）</font>
          </div>
          <div class="pjgl-2-1">
          ...
          <div class="tscl-2">
            ...
            <div style="border-top:2px solid #eee; clear:both; overflow:hidden;">
              ...
              <br/>
                ...
                仲裁结果：支持退款（<?=($refund['arbitrate_result_type']==3) ? '全额退款' : '部分退款'?>）<br/>
                退款金额：<?=$refund['arbitrate_result_amount']?><br/>
                仲裁时间：<?=$refund['arbitrate_result_time']?><br/>
                仲裁说明：经过平台客服认真调查核实，仲裁支持退款
              </div>
            </div>
          </div>
        </div>
